...
class LicenceManager {
    private let licenseTitle: String
    private let licenseText: String
    
    init() {
        licenseTitle = Titles.title1
        licenseText = Texts.text1
    }
}

//MARK: - ILicenceManager
extension LicenceManager: ILicenceManager {
...
//MARK: - Constants
extension LicenceManager {
    enum Titles {
        static let title1 = "LICENSED APPLICATION END USER LICENSE AGREEMENT"
    }
